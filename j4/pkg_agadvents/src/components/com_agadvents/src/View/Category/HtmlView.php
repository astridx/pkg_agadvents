...
namespace AgadventNamespace\Component\Agadvents\Site\View\Category;
...
/**
 * HTML View class for the Agadvents component
 *
...
class HtmlView extends CategoryView
{
	 ...
	 * @since  __BUMP_VERSION__
	 */
	protected $defaultPageTitle = 'COM_AGADVENT_DEFAULT_PAGE_TITLE';
	...
	protected function prepareDocument()
	{
		...
		if ($menu && (!isset($menu->query['option']) || $menu->query['option'] != $this->extension || $menu->query['view'] == $this->viewName
			...
			while ((!isset($menu->query['option']) || $menu->query['option'] !== 'com_agadvents' || $menu->query['view'] === 'agadvent'
