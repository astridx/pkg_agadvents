...
namespace AgadventNamespace\Component\Agadvents\Site\View\Featured;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function _prepareDocument()
	{
		...
		if ($menu) {
			...
			$this->params->def('page_heading', Text::_('COM_AGADVENTS_DEFAULT_PAGE_TITLE'));
		}
