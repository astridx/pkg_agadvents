...
namespace AgadventNamespace\Component\Agadvents\Site\Controller;
...
/**
 * Controller for single agadvent view
 *
...
class AgadventController extends FormController
{
	...
	protected function allowAdd($data = [])
	{
		if ($categoryId = ArrayHelper::getValue($data, 'catid', $this->input->getInt('catid'), 'int')) {
			...
			return $user->authorise('core.create', 'com_agadvents.category.' . $categoryId);
		}
