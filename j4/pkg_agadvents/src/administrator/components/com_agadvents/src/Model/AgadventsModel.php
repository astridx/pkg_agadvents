...
class AgadventsModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__agadvents_details', 'a'));
			...
			$subQuery = $db->getQuery(true)
				...
				->where(
					[
						...
						$db->quoteName('asso1.context') . ' = ' . $db->quote('com_agadvents.item'),
					]
				);
			...
			$query->join(
				...
				->where(
					[
						...
						$db->quoteName('tagmap.type_alias') . ' = ' . $db->quote('com_agadvents.agadvent'),
					]
				)
