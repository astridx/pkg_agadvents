...
ALTER TABLE`#__agadvents_details` ADD COLUMN `url` varchar(250) NOT NULL DEFAULT '';

ALTER TABLE`#__agadvents_details` ADD COLUMN `showurl` varchar(250) NOT NULL DEFAULT '';
