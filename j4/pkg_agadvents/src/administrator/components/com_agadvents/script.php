...
/**
 * Script file of Agadvent Component
 *
 * @since  __BUMP_VERSION__
 */
class Com_AgadventsInstallerScript extends InstallerScript
{
	/**
	...
	{
		echo Text::_('COM_AGADVENTS_INSTALLERSCRIPT_INSTALL');

		$db = Factory::getDbo();
		$alias   = ApplicationHelper::stringURLSafe('AgadventUncategorised');
		...
		$this->addDashboardMenu('agadvents', 'agadvents');
	...
	{
		echo Text::_('COM_AGADVENTS_INSTALLERSCRIPT_UNINSTALL');
	...
	{
		echo Text::_('COM_AGADVENTS_INSTALLERSCRIPT_UPDATE');

		$this->addDashboardMenu('agadvent', 'agadvent');
	...
	public function preflight($type, $parent): bool
	{
		...
		echo Text::_('COM_AGADVENTS_INSTALLERSCRIPT_PREFLIGHT');
	...
	{
		echo Text::_('COM_AGADVENTS_INSTALLERSCRIPT_POSTFLIGHT');
	...
	private function saveContentTypes()
	{
		...
		$table->load(['type_alias' => 'com_agadvents.agadvent']);
		...
		$tablestring = '{
			"special": {
			  ...
			  "key": "id",
			  "type": "AgadventTable",
			  "prefix": "AgadventNamespace\\\\Component\\\\Agadvents\\\\Administrator\\\\Table\\\\",
			  "config": "array()"
			},
			"common": {
		...
		$contenttype['type_title'] = 'Agadvents';
		$contenttype['type_alias'] = 'com_agadvents.agadvent';
		$contenttype['table'] = $tablestring;
		$contenttype['rules'] = '';
		$contenttype['router'] = 'RouteHelper::getAgadventRoute';
