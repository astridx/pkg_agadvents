 ...
 * @since  1.5
 */
abstract class AgadventsHelperRoute
{
	...
	/**
	 * Get the route of the agadvent
	 *
	 * @param   integer  $id        Agadvent ID
	...
	{
		$needles = array('agadvent'  => array((int) $id));
	 ...
	 * Ge the form route
	 *
	 * @param   integer  $id      The id of the agadvent.
	...
	public static function getFormRoute($id, $return = null)
	{
		...
		if ($id)
		{
			$link = 'index.php?option=com_agadvents&task=agadvent.edit&w_id=' . $id;
		}
		else
		{
			$link = 'index.php?option=com_agadvents&task=agadvent.add&w_id=0';
		}
	...
	protected static function _findItem($needles = null)
	{
		...
		if (!isset(self::$lookup[$language]))
		{
			...
			$component = JComponentHelper::getComponent('com_agadvents');
