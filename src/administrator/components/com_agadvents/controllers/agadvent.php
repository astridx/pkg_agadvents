...
class AgadventsControllerAgadvent extends JControllerForm
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Agadvent', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_agadvents&view=agadvents' . $this->getRedirectToListAppend(), false));
